...
const Htmlcss = () => {
	return (
		<div className="mentor">
			...
			<p>
				All these templates can be found on{' '}
				<a href="https://frontendmentor.io" target="_blank" rel="noopener noreferrer">
					Frontend mentor
				</a>
			</p>
			<div className="projects">
				...
				<Card
					...
					link=""
					name="Project tracking intro component(under construction)"
					text="HTML CSS"
