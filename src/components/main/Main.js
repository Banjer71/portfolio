        ...
        <main>
            <div className="projects">
                <div className="dv">
                    ...
                    <p>Here are some of the projects I built as a freelance mainly for private customers into music, fashion and costume design environment.</p>
                    <SocialMedia
                ...
                <Card className='image-bg kodflix'
                ...
                <Card className='image-bg ba'
                    ...
                    text={['For this projects, I wanted to restyle an old website I made with Wordpress for a', <a href="http://benitoantonelli.it" target="_blank" rel="noopener noreferrer"> passionate indipendent scholar of Naval Archeology.</a>]}
