...
import SC from "../../img/icons/styled-components-icon.png";

function Main(props) {
  let img = <img src={SC} alt="styled-component-icon" />;
  return (
    <main>
      <div className="projects">
        <div className="dv">
          ...
          <p>
            Here are some of the projects I built as a freelance mainly for
            private customers into music, fashion and costume design
            environment.
          </p>
          <SocialMedia
        ...
        <Card
          className="image-bg fcs"
          link="https://fabricservices.it/"
          name="Fabrics Consulting Services"
          text=" A website for a consulting company. I built it starting from a mobile first approach and it is fully responsive."
          text2="I used ReactJs and Styled-Components. Get familiar with EmailJs to manage a contact form without having a backend and a module called intl to translate the pages in Italian and English"
          html5={<i className="fab fa-html5" />}
          css3={<i className="fab fa-css3-alt" />}
          react={<i className="fab fa-react" />}
          sc={img}
        ...
        <Card
          ...
          link="https://www.francescolomagistro.it/"
          name="Francesco Lomagistro"
          text=" A website for a jazz drummer. I built it starting from a mobile first approach and it is fully responsive."
          text2="I used Reactjs. This was one of my first website I decided to refactor using ReactJs. "
          html5={<i className="fab fa-html5" />}
          css3={<i className="fab fa-css3-alt" />}
          react={<i className="fab fa-react" />}
        />
